...
public class FindPartTimeAcitivity extends ActionBarActivity {
    ...
    private void initView() {
        ...
        linearLayoutManager = new LinearLayoutManager(FindPartTimeAcitivity.this);
        recyclerView.setLayoutManager(linearLayoutManager);
        iv_back = (ImageView) findViewById(R.id.back);
        iv_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FindPartTimeAcitivity.this.finish();
            }
        });
    }
            ...
            public void onResponse(String json) {
                switch (type) {
                    case "homeData":
                        ...
                        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(FindPartTimeAcitivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                            @Override
                                ...
                                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                                    ...
                                    if (lastVisibleItem + 1 == secondHandMarketCategoryAdapter.getItemCount()) {
                                        ...
                                        if (pageEnd == false) {
                                            ...
                                            getJsonData(HttpUtil.GET_SECOND_MARKET_GOOD_BY_DIRECTORY_ID + 12 + "/p/" + page + "?limit=" + 1, "homeDataMore");
                    ...
                    case "detailData":
                        ...
                        Intent intent = new Intent(FindPartTimeAcitivity.this, SecondHandMarketGoodsDetailActivity.class);
